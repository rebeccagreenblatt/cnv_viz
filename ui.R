             ...
             tabPanel("Patient Data (adjusted)", fluid=TRUE,
                      sidebarLayout(
                        ...
                        mainPanel(
                          ...
                          column(9, offset = 1, textOutput("adj_copies")),
                          column(9, offset = 1, dataTableOutput("mutations")),
                          br(),
                          column(9, offset = 1, conditionalPanel("input.adj_chr != 'all'", plotlyOutput("adj_selected_plot")))
                        )
                      )),
