             ...
             tabPanel("Patient Data (adjusted)", fluid=TRUE,
                      sidebarLayout(
                        ...
                        mainPanel(
                          ...
                          column(11, offset = 1, conditionalPanel("input.adj_chr != 'all'", strong(textOutput("adj_copies")))),
                          column(11, offset = 1, conditionalPanel("input.adj_chr != 'all'", dataTableOutput("mutations"), style = 'padding:20px')),
                          column(11, offset = 1, conditionalPanel("input.adj_chr != 'all'", plotlyOutput("adj_selected_plot")), style = 'padding:20px')
                        )
                      )),
             tabPanel("Patient Data (unadjusted)", fluid=TRUE, 
                      sidebarLayout(
                        ...
                        mainPanel(
                          ...
                          br(),
                          column(11, offset = 1, conditionalPanel("input.chr != 'all'", plotlyOutput("selected_plot")))
                        )
                      )),
